...
-We name the variables so what we can refer them and the values they hold at a later time
...
//This is where the variable is created, by utilizing a designated JavaScropt keyword(var, let, const)and giving it a name

let s;

//The initialization is ot the right side of the assignment operator(=)
